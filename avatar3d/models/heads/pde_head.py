...
from avatar3d.models.bert.mlp_mixer import FeedForward, PreNormResidualBN
...
class PDEHead(BaseModule):
    ...
    def __init__(
        ...
        super(PDEHead, self).__init__(init_cfg=init_cfg)
...
class VHead_ID(VHead):  # ID or WID
    ...
    def __init__(
            ...
            init_cfg=None):
        super().__init__(convention, in_channels, cam_feat_dim, pred_kp3d,
                         ncam, nhdim, nhdim_cam, nverts_sub2, nverts_sub1,
                         nverts, init_cfg)
        self.dec_z = ZNet(**znet_config)
