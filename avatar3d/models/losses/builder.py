...
from avatar3d.models.losses.mse_loss import KeypointMSELoss, ImageGradMSELoss
from avatar3d.models.losses.smooth_loss import LimbSmoothLoss
from avatar3d.models.losses.prior_loss import (LimbLengthLoss, HingeLoss,
                                               LimbDirectionLoss)
from avatar3d.models.losses.render_loss import SilhouetteMSELoss, FlowWarpingLoss, SilhouetteRegLoss
from avatar3d.models.losses.mesh_loss import LaplacianLoss, ChamferLoss, MeshEdgeLoss, NormalConsistencyLoss
from avatar3d.models.losses.regression_loss import RLELoss, RLELossLight
from avatar3d.models.losses.norm_loss import NormLoss, MMDLoss
try:
