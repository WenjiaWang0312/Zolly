root = '/data1/wenjiawang/datasets/'
...
data_keys = [
    ...
    'is_flipped', 'ori_keypoints2d', 'smpl_origin_orient', 'ori_shape',
    'center', 'scale', 'bbox_info', 'ori_focal_length', 'inv_trans', 'trans',
    'img_h', 'img_w', 'distortion_max', 'is_distorted'
]
...
data_keys_test = [
    ...
    'ori_keypoints2d', 'ori_shape', 'center', 'scale', 'bbox_info',
