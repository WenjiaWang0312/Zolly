...
class HMRBodyHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 hdim=1024,
                 init_cfg=None):
        super(HMRBodyHead, self).__init__(init_cfg=init_cfg)
    ...
    def forward(self,
        ...
        pred_rotmat = rot6d_to_rotmat(pred_pose).view(batch_size, 23, 3, 3)

        if output_seq:
            pred_rotmat = pred_rotmat.view(B, T, 23, 3, 3)
