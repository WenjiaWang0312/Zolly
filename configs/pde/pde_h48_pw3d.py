from configs.prompt.base import (root, convention, body_model_train, demo_real,
                                 pw3d_train_transl, train_dict_pw3d,
                                 train_dict_no_d, body_model_test,
...
runner = dict(type='EpochBasedRunner', max_epochs=175)
...
data = dict(
    samples_per_gpu=128,
    workers_per_gpu=8,
    train=train_dict_no_d,  #pw3d_train_transl
    test=test_dict,
    demo=demo_real)
